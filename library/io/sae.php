...
//            'mimes'				=> array(),
    ...
    public function data()
    {
        return array(
            ...
            'file_path'			=> Yaf_Registry::get('IO_TRUE_NAME')=='sae' ? $this->sae_domain.'/'.$this->upload_path : $this->upload_path,
            'full_path'			=> Yaf_Registry::get('IO_TRUE_NAME')=='sae' ? $this->storage_url : $this->upload_path.$this->file_name,
    ...
    public function set_filename($path, $filename)
    {
        ...
        if (Yaf_Registry::get('IO_TRUE_NAME')=='sae')
        {
            if ( ! $this->sae_storage->fileExists($this->sae_domain, $path.$filename))
                return $filename;
        }
        ...
        for ($i = 1; $i < 100; $i++)
        {
            if (Yaf_Registry::get('IO_TRUE_NAME')=='sae')
            {
                if ( ! $this->sae_storage->fileExists($this->sae_domain, $path.$filename.$i.$this->file_ext))
                {
